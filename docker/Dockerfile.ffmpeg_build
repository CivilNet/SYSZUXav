#based on https://github.com/leandromoreira/ffmpeg-libav-tutorial/blob/master/Dockerfile
...
RUN \
        ...
        mkdir -p ${dir} ; \
        cd ${dir} ; \
        curl -sLO https://raw.githubusercontent.com/gemfield/repo/master/aom-v1.0.0.tar.gz ; \
        tar -zx -f aom-v1.0.0.tar.gz ; \
